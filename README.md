...
❌ Tired of fragile releases, rising cloud costs, or noisy alerts?
You're not alone. Most teams ship tools—not reliable platforms.
...
• Pass security reviews with confidence (policies, logging, least privilege)
...
Computer Networking • Telecommunications • Data Recovery • Network Support • Backup & Recovery Systems • Cloud Management
...
Founder - IT Consultancy Company specialises in DevOps and Cloud Services

**Skills:** DevOps, Amazon Web Services (AWS) and +9 skills
...
• Helping to architect and design secure cloud infrastructures
• Responsible for ensuring that the infrastructure runs reliably and efficiently

**Skills:** Continuous Integration and Continuous Delivery (CI/CD), Infrastructure as code (IaC) and +13 skills
...
**Skills:** Continuous Integration and Continuous Delivery (CI/CD), Infrastructure as code (IaC) and +1 skill
...
• Responsible for ensuring that the infrastructure runs reliably and efficiently
• Ensure practices towards a continuous integration/continuous deployment model across multiple projects
...
Linux servers Debian/Ubuntu, and CentOS.
Distributed file systems such as GlusterFS and NFS shares.

**Skills:** Continuous Integration and Continuous Delivery (CI/CD), Infrastructure as code (IaC) and +2 skills
...
For the most up-to-date version of my CV and complete professional profile, please visit my [LinkedIn profile](https://www.linkedin.com/in/saulramosvaca).
